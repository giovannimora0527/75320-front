...
export class PrestamoService {
  ...
  guardarPrestamo(prestamo: Prestamo): Observable<Respuesta> {
    return this.backendService.post(environment.apiUrlAuth, this.api, 'crear', prestamo);
  }

  entregarLibro(prestamo: Prestamo): Observable<Respuesta> {
    return this.backendService.post(environment.apiUrlAuth, this.api, 'actualizar', prestamo);
  }
  }